    ...
    public class DatabaseService
    {
        ...
        public async Task SyncRestaurantsAsync(List<Restaurant> apiData)
        {
            ...
            foreach (var r in apiData)
            {
                ...
                // InsertAllAsync không cập nhật lại r.Id → gây AudioGuide.RestaurantId = 0
                var cmsId = r.Id; // lưu Id gốc từ CMS
                await _db.InsertAsync(r);
                // Sau InsertAsync, nếu AutoIncrement thì r.Id đã được cập nhật
                // Nhưng để chắc chắn, dùng Id từ CMS nếu không AutoIncrement
