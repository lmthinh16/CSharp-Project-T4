...
namespace ProjectApp.ViewModels
{
    ...
    public partial class MainViewModel : ObservableObject
    {
        ...
        public MainViewModel()
        {
            ...
            _queue.OnPlaybackStateChanged += playing =>
            {
                MainThread.BeginInvokeOnMainThread(() =>
    ...
    public partial class RestaurantDetailViewModel : ObservableObject
    {
        ...
        // Phát audio guide vào queue
        [RelayCommand]
        void PlayAudio(AudioGuide guide)
        {
            bool enqueued = _queue.TryEnqueue(guide);
            if (!enqueued)
                MainThread.BeginInvokeOnMainThread(async () =>
                    await Shell.Current.DisplayAlert(
                        "Thông báo", $"\"{guide.Title}\" đã có trong hàng chờ.", "OK"));
        }
