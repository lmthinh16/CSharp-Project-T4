...
namespace ProjectApp.Models
{
    ...
    public class Restaurant
    {
        ...
        // FIX: Server trả double? (nullable) -> phải khai báo double? ở app
        // Tránh JsonException khi server trả "lat": null -> GetRestaurantsAsync crash -> return []
        ...
        // ── Helper cho UI Binding (Đa ngôn ngữ) ───────────────────
        [Ignore]
        public string DisplayName => Services.UserSession.Language switch { "en" => !string.IsNullOrEmpty(NameEn) ? NameEn : Name, "zh" => !string.IsNullOrEmpty(NameZh) ? NameZh : Name, _ => Name };

        [Ignore]
        public string DisplayDescription => Services.UserSession.Language switch { "en" => !string.IsNullOrEmpty(DescriptionEn) ? DescriptionEn : Description, "zh" => !string.IsNullOrEmpty(DescriptionZh) ? DescriptionZh : Description, _ => Description };
    ...
    public class Tour
    {
        ...
        [Ignore]
        public string DisplayDescription => Services.UserSession.Language switch { "en" => !string.IsNullOrEmpty(DescEn) ? DescEn : Description, "zh" => !string.IsNullOrEmpty(DescZh) ? DescZh : Description, _ => Description };
    ...
    public class PoiStats
    {
        ...
        /// <summary>Thời gian nghe trung bình mỗi lần (giây)</summary>
