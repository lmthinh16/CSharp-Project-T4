            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(guide.FilePath) && guide.FilePath.StartsWith("http"))
                {
                    ...
                    try
                    {
                        ...
                        _player = Plugin.Maui.Audio.AudioManager.Current.CreatePlayer(tmpPath);
                ...
                {
                    token.ThrowIfCancellationRequested();
                    // Android TTS requires main thread context — InvokeOnMainThreadAsync ensures this
                    await MainThread.InvokeOnMainThreadAsync(() =>
                        TextToSpeech.Default.SpeakAsync(
                            ttsText,
