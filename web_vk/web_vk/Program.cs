...
// --- API ĐO LƯỜNG HÀNH VI (ANALYTICS GAP FILLER) ---
// Tạm thời nuốt các request gửi từ sự kiện nghe Audio hoặc Lưu Quán ăn của app mobile (tránh 404 crash).
app.MapPost("/api/analytics", (object payload) =>
{
    Console.WriteLine($"[Analytics] WebCMS đã nhận Log từ Mobile: {System.Text.Json.JsonSerializer.Serialize(payload)}");
